...
exports.home_r = function(request, response){
    ...
    db.query(`SELECT * FROM topic`, function(error,topics){   
        db.query(`SELECT * FROM author`, function(error2,authors ){
            ...
            html = template.HTML(title, list,
                ...
                <form action="/author/create_process_r" method="post">
                    <p>
                        name : <input type="text" name="name" placeholder="name">
                    </p>
                    <p>
                        profile : <textarea name="profile" placeholder="description"></textarea>
                    </p>
                    <p>
                        <input type="submit" value="create">
                    </p>
  ...
  exports.create_process_r = function(request, response){
    var body = '';
      request.on('data', function(data){
          body = body + data;
      });
...
exports.update_r = function(request, response){
    db.query(`SELECT * FROM topic`, function(error,topics){
        db.query(`SELECT * FROM author`, function(error2,authors){
            var title = 'author';
            var list = template.list(topics);
...
exports.update_process_r = function(request, response){
    var body = '';
    request.on('data', function(data){
          body = body + data;
    });
...
exports.update_process_r1 = function(request, response){
...
exports.delete_process_r = function(request, response){
    var body = '';
    request.on('data', function(data){
          body = body + data;
    });
